package net.rotko.zigner.domain.backend

import net.rotko.zigner.screens.settings.networks.signspecs.SignSpecsListModel
import net.rotko.zigner.screens.settings.networks.signspecs.SignSpecsResultModel
import net.rotko.zigner.screens.settings.networks.signspecs.toSignSpecsListModel
import net.rotko.zigner.screens.settings.networks.signspecs.toSignSpecsResultModel
