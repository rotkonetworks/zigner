package net.rotko.zigner.screens.settings.logs
...
import net.rotko.zigner.screens.settings.logs.comment.AddLogCommentScreen
import net.rotko.zigner.screens.settings.logs.logdetails.LogDetailsScreen
import net.rotko.zigner.screens.settings.logs.logslist.LogsScreenFull
