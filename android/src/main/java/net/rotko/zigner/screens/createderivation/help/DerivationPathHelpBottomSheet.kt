package net.rotko.zigner.screens.createderivation.help
...
import net.rotko.zigner.ui.theme.backgroundTertiary
import net.rotko.zigner.ui.theme.textSecondary

//not used after redesign for now
@Composable
fun DerivationPathHelpBottomSheet(
	onClose: Callback,
) {
	Column(
        Modifier
		...
		Text(
			text = stringResource(R.string.derivation_help_path_message),
...
@Composable
private fun PreviewDerivationPathHelpBottomSheet() {
	SignerNewTheme {
