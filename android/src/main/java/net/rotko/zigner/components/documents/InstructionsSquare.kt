...
import net.rotko.zigner.ui.theme.Bg200
import net.rotko.zigner.ui.theme.Text300
import net.rotko.zigner.ui.theme.Text600
import net.rotko.zigner.ui.theme.Typography
...
fun InstructionsSquare() {
	Surface (
		...
		Column(Modifier.padding(16.dp)) {
			...
			Text("Airgap your phone", style = Typography.body2, color = MaterialTheme.colors.Text600)
			Text(
