...
Rotko Networks OÜ, Harju maakond, Tallinn, Estonia (hereinafter "**Rotko Networks**" or “**we**”) offers the mobile application Zigner (hereinafter: “**Vault**”), a non-custodial wallet software that allows the User to turn his/her mobile device, such as smartphone or tablet (hereinafter: “**Storage Device**”), into a cold storage hardware wallet by holding the User’s private cryptographic keys offline while keeping the Storage Device offline. The Vault can be downloaded from the Apple App Store and from the Google Play Store. The User can use the Vault to safekeep their Private Keys, manage their accounts and blockchain-based digital assets (hereinafter: “**Digital Assets**”), send and receive transactions of Digital Assets, and cryptographically sign blockchain transactions. The Vault contains certain features that, inter alia, allow the User to connect the Vault to third-party decentralized applications (hereinafter: “**DApp**”), protocols and services that Rotko Networks does not operate itself (hereinafter: “**Third-Party Services**”). Rotko Networks does not offer Third-Party Services in its own name. Further information about the functions offered in connection with the Vault can be found in Rotko Networks’s General terms and conditions of business and use (hereafter “GTC”). We encourage you to read the GTC carefully as they affect your obligations and legal rights regarding the usage of the Vault.

In connection with the usage of the Vault, no personal data will be processed by Rotko Networks since the Vault will be installed on Users’ Storage Device without Rotko Networks having access to any personal data of the User when using the Vault. However, Rotko Networks may process personal data of persons who visit Rotko Networks’s website https://rotko.net/ (hereinafter each a “**Website** and together “**Websites**”) and/or contact Rotko Networks. Personal data is information that relates to an identified or identifiable natural person. An identifiable natural person is a person who can be identified directly or indirectly, e.g., by means of association with an online identifier (hereinafter: “**Data Subject**”).

Rotko Networks takes the protection of personal data very seriously. We treat personal data confidentially, in accordance with this Privacy Notice and applicable data protection law, including, but not limited to the General Data Protection Regulation (hereinafter: "**GDPR**") and the Estonian Personal Data Protection Act (hereinafter: "**PDPA**").
...
Rotko Networks acts as responsible party and, hence, as controller within the meaning of the GDPR with regard to the personal data processed in connection with the Websites or any contacting of Rotko Networks. A controller is a natural or legal person who alone or jointly with others decides on the purposes and means of the processing of personal data.
...
We initially process and store your personal data for the duration for which the respective purpose of use requires corresponding storage (see above under Section 3 on the individual processing purposes). This may also include the periods of initiating a contract (pre-contractual legal relationship) and processing a contract. On this basis, personal data is regularly deleted as part of the fulfilment of our contractual and/or legal obligations, unless its temporary further processing is necessary for the following purposes:
    ...
    · Fulfilment of legal storage obligations, which result, for example, from the Estonian Accounting Act and applicable tax regulations. The periods specified for storage or documentation are up to seven years.

    · Preservation of evidence taking into account the statute of limitations under applicable Estonian law and EU regulations.
...
**h) Right of appeal to a supervisory authority:** Subject to the conditions of Art. 77 GDPR, you have the right to lodge a complaint with a competent supervisory authority. As a rule, the Data Subject can turn to the supervisory authority at his/her habitual residence or place of work or Rotko Networks's registered office. The supervisory authority responsible for Rotko Networks is the Estonian Data Protection Inspectorate (Andmekaitse Inspektsioon).
...
We keep this Privacy Notice under regular review and may update it at any time. If we make any changes to this Privacy Notice, we will change the "Last Updated" date above. Please review this Privacy Notice regularly to check for any updates. The current version of the Privacy Notice can be accessed at any time on https://rotko.net/zigner-privacy.
